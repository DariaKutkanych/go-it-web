...
class Handler:
    ...
    def action_search_note(self):
        while True:
            ...
            head_notes = {"3", "3.", "головному",
                          "головне", "главному", "main"}
    ...
    def total_actions(self):
        while True:
            ...
            edit_data = {"3", "3.", "редагувати", "редактировать", "edit",
                         "змінити"}
            delete_data = {"4", "4.", "удалить",
                           "видалити", "стерти", "delete"}
            ...
            if len(user_text & create_contact) >= 1:
                ...
                name_record = self.address_book.search_by_name(name)
                if name_record:
                    self.action_add_contact(name_record)
                else:
